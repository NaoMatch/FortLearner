program main_lawu
    ...
    type(lawu_regressor)    :: et_reg_slow, et_reg_fast, et_reg_fast_more
    type(lawu_regressor)    :: et
...
!     n_iters = 1
    ...
    do iii=1, 5, 1
        ...
        do jjj=1, 5, 1
            ...
            max_leaf_nodes = 100
            print*, '============================================================='
            print*, "Start Training DecisionTree_Fast"
            et_reg_fast = lawu_regressor(max_leaf_nodes=max_leaf_nodes, fashion="best", & 
