subroutine read_bin_1d_r8(file_name, vector, print_log)
    implicit none
...
subroutine read_bin_1d_i4(file_name, vector, print_log)
    implicit none
    character(len=*), intent(in) :: file_name
...
subroutine read_bin_1d_i8(file_name, vector, print_log)
    implicit none
    character(len=*), intent(in) :: file_name
