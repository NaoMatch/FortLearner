function binary_search_right_branchless_r8(vector, n_samples, value) result(idx)
    implicit none
    integer(kind=8) :: idx
...
end function binary_search_right_branchless_r8

function binary_search_right_branchless_i4(vector, n_samples, value) result(idx)
    implicit none
    integer(kind=4)             :: idx
    ...
    include "./include/common/binary_search/inc_binary_search_right_branchless_detail.f90"
end function binary_search_right_branchless_i4

function binary_search_right_branchless_i8(vector, n_samples, value) result(idx)
    implicit none
    integer(kind=8)            :: idx
    ...
    integer(kind=8) :: lo, hi, mid, step, step_, flg
    include "./include/common/binary_search/inc_binary_search_right_branchless_detail.f90"
end function binary_search_right_branchless_i8
