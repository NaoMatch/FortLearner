subroutine groupby_sq_sum_r4_r4(uniq_x, x, stat_y, y, n_samples)
    implicit none
...
end subroutine groupby_sq_sum_r4_r4

subroutine groupby_sq_sum_r8_i8(uniq_x, x, stat_y, y, n_samples)
    implicit none
    ...
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_detail.f90"
end subroutine groupby_sq_sum_r8_i8

subroutine groupby_sq_sum_r8_r8(uniq_x, x, stat_y, y, n_samples)
    implicit none
    real(kind=8), allocatable    :: uniq_x(:)
    real(kind=8), intent(in)     :: x(n_samples)
    ...
    integer(kind=8), allocatable :: positions(:)
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_detail.f90"
end subroutine groupby_sq_sum_r8_r8

subroutine groupby_sq_sum_i4_i4(uniq_x, x, stat_y, y, n_samples)
    implicit none
    ...
    integer(kind=4), allocatable :: positions(:)
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_detail.f90"
end subroutine groupby_sq_sum_i4_i4

subroutine groupby_sq_sum_i4_r4(uniq_x, x, stat_y, y, n_samples)
    implicit none
    integer(kind=4), allocatable :: uniq_x(:)
    integer(kind=4), intent(in)  :: x(n_samples)
    real(kind=4), allocatable    :: stat_y(:)
    ...
    integer(kind=4), allocatable :: positions(:)
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_detail.f90"
end subroutine groupby_sq_sum_i4_r4

subroutine groupby_sq_sum_i8_i8(uniq_x, x, stat_y, y, n_samples)
    implicit none
    ...
    integer(kind=8), allocatable :: positions(:)
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_detail.f90"
end subroutine groupby_sq_sum_i8_i8

subroutine groupby_sq_sum_i8_r8(uniq_x, x, stat_y, y, n_samples)
    implicit none
    integer(kind=8), allocatable :: uniq_x(:)
    integer(kind=8), intent(in)  :: x(n_samples)
    real(kind=8), allocatable    :: stat_y(:)
    ...
    integer(kind=8), allocatable :: positions(:)
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_detail.f90"
end subroutine groupby_sq_sum_i8_r8
