subroutine groupby_sq_sum_self_r8(uniq_x, stat_x, x, n_samples)
    implicit none
...
end subroutine groupby_sq_sum_self_r8

subroutine groupby_sq_sum_self_i4(uniq_x, stat_x, x, n_samples)
    implicit none
    ...
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_self_detail.f90"
end subroutine groupby_sq_sum_self_i4

subroutine groupby_sq_sum_self_i8(uniq_x, stat_x, x, n_samples)
    implicit none
    ...
    integer(kind=8), allocatable :: positions(:)
    include "./include/stats/groupby_sq_sum/inc_groupby_sq_sum_self_detail.f90"
end subroutine groupby_sq_sum_self_i8
