...
x = np.r_[x0,x1]
pd.DataFrame(x).to_csv("../sample_data/svm_hard_x_40x2.csv", index=False)
pd.DataFrame(y).to_csv("../sample_data/svm_hard_y_40x1.csv", index=False)
...
x = np.r_[x0,x1]
pd.DataFrame(x).to_csv("../sample_data/svm_soft_x_40x2.csv", index=False)
pd.DataFrame(y).to_csv("../sample_data/svm_soft_y_40x1.csv", index=False)
