program main_linear_regression_ridge_regression
    use mod_timer
    ...
    type(ridge_regression) :: lr, lr2, lr3
    type(metrics)                 :: metric
...
end program main_linear_regression_ridge_regression
