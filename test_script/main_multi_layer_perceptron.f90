program main_multi_layer_perceptron
    ...
    type(variable) :: var_x, var_y, var_a, var_b, var_c, var_d, var_e, var_f, var_g, var_h, var_i
    type(variable) :: var_j, var_k
    type(variable) :: var_v, var_w
    type(variable) :: var_xx, var_yy, var_ww, var_bb
    ...
    do iter=1, max_iter, 1
        ...
        var_i  = act9%division(var_h, var_j) ! sum(y_diff^2_i) / batch_size

        var_i%g = g
        call var_i%backward_variable_subroutine()
        ! print*, var_g%v
