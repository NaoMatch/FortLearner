program main_boosting_tree_gradient_boosting_lawu_regressor
    use mod_gradient_boosting_lawu
    use mod_metric
    use mod_data_holder
    implicit none
    ...
    type(metrics) :: metric
    type(gradient_boosting_lawu_regressor) :: gbdt_reg, gbdt_reg2
...
end program main_boosting_tree_gradient_boosting_lawu_regressor