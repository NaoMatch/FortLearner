program main_sum_up_left
    ...
    Interface
        ...
        function sum_up_left_assembler_02_c_i8_i8(x,y,n,v) Bind(C,Name='sum_up_left_assembler_02_c_i8_i8')
            Import
            Integer(c_int64_t)            :: sum_up_left_assembler_02_c_i8_i8
            Integer(c_int64_t),Value      :: n
            Integer(c_int64_t),Intent(In) :: x(n), y(n)
            Integer(c_int64_t),Value      :: v
        end function    
        ...
        function sum_up_left_assembler_02_c_r8_r8(x,y,n,v) Bind(C,Name='sum_up_left_assembler_02_c_r8_r8')
            Import
            Real(c_double)            :: sum_up_left_assembler_02_c_r8_r8
            Integer(c_int64_t),Value  :: n
            Real(c_double),Intent(In) :: x(n), y(n)
            Real(c_double),Value  :: v
        end function    
    ...
    types(8)  = "sum_naive_assember_02_C     :"
    types(9)  = "sum_naive_assember_04_C     :"
    types(10) = "sum_naive_assember_08_C     :"
    types(11) = "sum_naive_assember_16_C     :"
    types(12) = "sum_naive_assember_20_C     :"
    types(13) = "sum_naive_assember_24_C     :"
    types(14) = "sum_hybrid                  :"
    ...
    do k=120, 200, 1
        ...
        n_iter=maxval((/3000000000_8/n_i8, 1_8/))
        ! n_iter=1
        ...
        do iter_types=1, n_types, 1
            ...
            do iter=1, n_iter, 1
                select case(iter_types)
                    ...
                    case (8)
                            res_r8 = sum_up_left_assembler_02_c_r8_r8(x_r8, y_r8, n_i8, thre_r8)
                    case (9)
                    ...
                    case (14)
                            res_r8 = sum_up_left_hydrid_r8(x_r8, y_r8, n_i8, thre_r8)
                end select
            end do
            call date_and_time(values=date_value2)
            times(iter_types) = time_diff(date_value1, date_value2)/dble(n_iter) - times(1)
        ...
        do iter_types=1, n_types, 1
            ...
            do iter=1, n_iter, 1
                select case(iter_types)
                    ...
                    case (8)
                            res_i8 = sum_up_left_assembler_02_c_i8_i8(x_i8, y_i8, n_i8, thre_i8)
                    case (9)
                    ...
                    case (14)
                            res_i8 = sum_up_left_hydrid_i8(x_i8, y_i8, n_i8, thre_i8)
                end select
            end do
            call date_and_time(values=date_value2)
            times(iter_types) = time_diff(date_value1, date_value2)/dble(n_iter) - times(1)
...
contains
    ...
    function sum_up_left_hydrid_i8(x, y, n, v)
        implicit none
        integer(kind=8), intent(in) :: x(n), y(n), v
        integer(kind=8), intent(in) :: n
        integer(kind=8)             :: sum_up_left_hydrid_i8
        if (n .le. 256_8) then
            sum_up_left_hydrid_i8 = sum_up_left_assembler_08_c_i8_i8(x, y, n, v)
        elseif ( n .le. 10000000_8 ) then
            sum_up_left_hydrid_i8 = sum_up_left_assembler_24_c_i8_i8(x, y, n, v)
        else
            sum_up_left_hydrid_i8 = sum_up_left_assembler_08_c_i8_i8(x, y, n, v)
        end if
    end function sum_up_left_hydrid_i8

    function sum_up_left_hydrid_r8(x, y, n, v)
        implicit none
        real(kind=8), intent(in)    :: x(n), y(n), v
        integer(kind=8), intent(in) :: n
        real(kind=8)                :: sum_up_left_hydrid_r8
        if (n .le. 3000_8) then
            sum_up_left_hydrid_r8 = sum_up_left_assembler_08_c_r8_r8(x, y, n, v)
        elseif ( n .le. 10000000_8 ) then
            sum_up_left_hydrid_r8 = sum_up_left_assembler_20_c_r8_r8(x, y, n, v)
        else
            sum_up_left_hydrid_r8 = sum_up_left_assembler_04_c_r8_r8(x, y, n, v)
        end if
    end function sum_up_left_hydrid_r8
