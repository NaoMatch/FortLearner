program main_boosting_tree_gradient_boosting_clouds_regressor
    use mod_gradient_boosting_clouds
    use mod_metric
    use mod_data_holder
    implicit none
    ...
    type(metrics) :: metric
    type(gradient_boosting_clouds_regressor) :: gbdt_reg, gbdt_reg2
...
end program main_boosting_tree_gradient_boosting_clouds_regressor