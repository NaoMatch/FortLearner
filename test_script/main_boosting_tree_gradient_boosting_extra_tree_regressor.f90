program main_boosting_tree_gradient_boosting_extra_tree_regressor
    use mod_gradient_boosting_extra_tree
    use mod_metric
    use mod_data_holder
    implicit none
    ...
    type(metrics) :: metric
    type(gradient_boosting_extra_tree_regressor) :: gbdt_reg, gbdt_reg2
    ...
    print*, '============================================================='
    print*, "Train: "
    gbdt_reg = gradient_boosting_extra_tree_regressor(n_estimators=100_8, max_depth=6_8)
...
end program main_boosting_tree_gradient_boosting_extra_tree_regressor