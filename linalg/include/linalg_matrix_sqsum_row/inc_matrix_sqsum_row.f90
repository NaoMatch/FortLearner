...
subroutine matrix_sqsum_row_02x01_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
    ...
    matrix_sqsum_vals(:) = 0d0
    !$omp parallel num_threads(4) shared(matrix)
    !$omp do reduction(+:matrix_sqsum_vals) private(i,j, r00, r01, r14, r15) 
    do j=1, n_columns_unroll, c_unroll
        do i=1, n_samples_unroll, s_unroll
            r00 = matrix_sqsum_vals(i)
            r01 = matrix_sqsum_vals(i+1)
    ...
    !$omp end do
    !$omp end parallel
end subroutine matrix_sqsum_row_02x01_F_P_r8

subroutine matrix_sqsum_row_04x01_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
    ...
    !$omp end do
    !$omp end parallel
end subroutine matrix_sqsum_row_04x01_F_P_r8

subroutine matrix_sqsum_row_08x01_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
    ...
    !$omp end do
    !$omp end parallel
end subroutine matrix_sqsum_row_08x01_F_P_r8

subroutine matrix_sqsum_row_16x01_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
    ...
    !$omp end do
    !$omp end parallel
end subroutine matrix_sqsum_row_16x01_F_P_r8

subroutine matrix_sqsum_row_32x01_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
    ...
    !$omp end do
    !$omp end parallel
end subroutine matrix_sqsum_row_32x01_F_P_r8



subroutine matrix_sqsum_row_01x02_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_01x02_F_P_r8

subroutine matrix_sqsum_row_01x04_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_01x04_F_P_r8

subroutine matrix_sqsum_row_01x08_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_01x08_F_P_r8

subroutine matrix_sqsum_row_01x16_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_01x16_F_P_r8

subroutine matrix_sqsum_row_01x32_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_01x32_F_P_r8



subroutine matrix_sqsum_row_02x02_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_02x02_F_P_r8

subroutine matrix_sqsum_row_02x04_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_02x04_F_P_r8

subroutine matrix_sqsum_row_02x08_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_02x08_F_P_r8

subroutine matrix_sqsum_row_02x16_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_02x16_F_P_r8

subroutine matrix_sqsum_row_02x32_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_02x32_F_P_r8




subroutine matrix_sqsum_row_04x02_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_04x02_F_P_r8

subroutine matrix_sqsum_row_04x04_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_04x04_F_P_r8

subroutine matrix_sqsum_row_04x08_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_04x08_F_P_r8

subroutine matrix_sqsum_row_04x16_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_04x16_F_P_r8

subroutine matrix_sqsum_row_04x32_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_04x32_F_P_r8




subroutine matrix_sqsum_row_08x02_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_08x02_F_P_r8

subroutine matrix_sqsum_row_08x04_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_08x04_F_P_r8

subroutine matrix_sqsum_row_08x08_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_08x08_F_P_r8

subroutine matrix_sqsum_row_08x16_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_08x16_F_P_r8

subroutine matrix_sqsum_row_08x32_F_P_r8(matrix, matrix_sqsum_vals, n_samples, n_columns)
    implicit none
    real(kind=8), intent(in)    :: matrix(n_samples, n_columns)
    real(kind=8), intent(inout) :: matrix_sqsum_vals(n_samples)
    integer(kind=8), intent(in) :: n_samples, n_columns
...
end subroutine matrix_sqsum_row_08x32_F_P_r8
