...
module mod_linalg
    ...
    !> An interface to call inner_product_real32, inner_product_real64, inner_product_int32, inner_product_int64
    interface inner_product
        module procedure :: inner_product_real32
        module procedure :: inner_product_real64
        module procedure :: inner_product_int32
        module procedure :: inner_product_int64
    end interface inner_product

    !> An interface to call cholesky_decomposition_real32, cholesky_decomposition_real64, cholesky_decomposition_int32, cholesky_decomposition_int64
    interface cholesky_decomposition
        module procedure :: cholesky_decomposition_real32
        module procedure :: cholesky_decomposition_real64
        module procedure :: cholesky_decomposition_int32
        module procedure :: cholesky_decomposition_int64
    end interface cholesky_decomposition

    !> An interface to call cholesky_decomposition_modified_real32, cholesky_decomposition_modified_real64, cholesky_decomposition_modified_int32, cholesky_decomposition_modified_int64
    interface cholesky_decomposition_modified
        module procedure :: cholesky_decomposition_modified_real32
        module procedure :: cholesky_decomposition_modified_real64
        module procedure :: cholesky_decomposition_modified_int32
        module procedure :: cholesky_decomposition_modified_int64
    end interface cholesky_decomposition_modified

    !> An interface to call inv_unit_lower_matrix_real32, inv_unit_lower_matrix_real64, inv_unit_lower_matrix_int32, inv_unit_lower_matrix_int64
    interface inv_unit_lower_matrix
        module procedure :: inv_unit_lower_matrix_real32
        module procedure :: inv_unit_lower_matrix_real64
        module procedure :: inv_unit_lower_matrix_int32
        module procedure :: inv_unit_lower_matrix_int64
    end interface inv_unit_lower_matrix

    !> An interface to call multi_mat_vec_real32, multi_mat_vec_real64, multi_mat_vec_int32, multi_mat_vec_int64
    interface multi_mat_vec
        module procedure :: multi_mat_vec_real32
        module procedure :: multi_mat_vec_real64
        module procedure :: multi_mat_vec_int32
        module procedure :: multi_mat_vec_int64
    end interface multi_mat_vec

    !> An interface to call supremum_eigen_value_real32, supremum_eigen_value_real64, supremum_eigen_value_int32, supremum_eigen_value_int64
    interface supremum_eigen_value
        module procedure :: supremum_eigen_value_real32
        module procedure :: supremum_eigen_value_real64
        module procedure :: supremum_eigen_value_int32
        module procedure :: supremum_eigen_value_int64
    end interface supremum_eigen_value

    !> Interface to call mattxmat_real32, mattxmat_real64, mattxmat_int32, mattxmat_int64
    interface mattxmat
        module procedure mattxmat_real32
        module procedure mattxmat_real64
        module procedure mattxmat_int32
        module procedure mattxmat_int64
    end interface mattxmat

    !> Interface to call rotate_from_left
    interface rotate_from_left
        module procedure rotate_from_left_real32
        module procedure rotate_from_left_real64
    end interface rotate_from_left

    !> Interface to call rotate_from_right
    interface rotate_from_right
        module procedure rotate_from_right_real32
        module procedure rotate_from_right_real64
    end interface rotate_from_right

    !> Interface to call rotate_from_both_side
    interface rotate_from_both_side
        module procedure rotate_from_both_side_real32
        module procedure rotate_from_both_side_real64
...
contains
    ...
    function supremum_eigen_value_real32(matrix, n_dim)
        implicit none
        real(kind=4), intent(in) :: matrix(n_dim, n_dim)
        integer(kind=4), intent(in) :: n_dim
        real(kind=4) :: supremum_eigen_value_real32
        real(kind=4) :: tmp
        include "./include/linalg_supremum_eigen_value/inc_supremum_eigen_value_detail.f90"
        supremum_eigen_value_real32 = tmp
    end function supremum_eigen_value_real32
    ...
    subroutine multi_mat_vec_real32(matrix, input_vector, output_vector, n_rows, n_cols)
        implicit none
    ...
    end subroutine multi_mat_vec_real32
    ...
    subroutine inv_unit_lower_matrix_real32(matrix_inv, matrix_unit_lower, n_dim)
        implicit none
    ...
    end subroutine inv_unit_lower_matrix_real32
    ...
    function inner_product_real32(vector_1, vector_2, num)
        real(kind=4), intent(in)    :: vector_1(num), vector_2(num)
        integer(kind=4), intent(in) :: num
        real(kind=4)                :: inner_product_real32
        real(kind=4)                :: tmp_sum

        include "./include/linalg_inner_product/inc_inner_product_detail.f90"
        inner_product_real32 = tmp_sum
    end function inner_product_real32
    ...
    subroutine cholesky_decomposition_real32(matrix_lower, matrix, n_dim)
        implicit none
    ...
    end subroutine cholesky_decomposition_real32
    ...
    !> \param matrix input positive definite symmetrix matrix
    !> \param rank of input/output matrix
    subroutine cholesky_decomposition_modified_real32(matrix_lower, diagonal_elements, matrix, n_dim)
        implicit none
        real(kind=4), intent(inout) :: matrix_lower(n_dim, n_dim)
    ...
    end subroutine cholesky_decomposition_modified_real32
    ...
    subroutine mattxmat_real32(mat_out, mat_in, n_rows, n_cols, with_intercept)
        implicit none
    ...
    end subroutine mattxmat_real32
    ...
    subroutine rotate_from_left_real32(mat, n_dim, loc, c_theta, s_theta)
        implicit none
    ...
    end subroutine rotate_from_left_real32
    ...
    !! \param c_theta cos(theta)
    !! \param s_theta sin(theta)
    subroutine rotate_from_right_real32(mat, n_dim, loc, c_theta, s_theta)
        implicit none
        real(kind=4), intent(inout) :: mat(n_dim, n_dim)
        integer(kind=4), intent(in) :: n_dim
        integer(kind=4), intent(in) :: loc(2)
    ...
    end subroutine rotate_from_right_real32
    ...
    !! \param c_theta cos(theta)
    !! \param s_theta sin(theta)
    subroutine rotate_from_both_side_real32(mat, n_dim, loc, c_theta, s_theta)
        implicit none
        real(kind=4), intent(inout) :: mat(n_dim, n_dim)
        integer(kind=4), intent(in) :: n_dim
        integer(kind=4), intent(in) :: loc(2)
    ...
    end subroutine rotate_from_both_side_real32
