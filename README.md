...
# WIP:  
Parallel predict for tree-type estimators    
~KDTree Optimization, Naive Bayse, Implement Linear/Kernel SVR, One-Class SVM, ica~


# Update
2023/03/29: Thinning (isolation_forest)  
