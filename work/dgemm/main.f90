program main
    ...
    integer(kind=8), allocatable :: mat_sizes(:), indices(:)
    ...
    do n=1, size(mat_sizes), 1
        ...
        do t=1, n_cases, 1
            ...
            do iter=1, n_iter, 1
                    select case (t)
                        ...
                        case (18); call my_dgemm_007(a_ptr,b_ptr,c0_ptr,mat_size,mat_size,mat_size) ! 交互法
                        case (19); call my_dgemm_008(a_ptr,b_ptr,c0_ptr,mat_size,mat_size,mat_size) ! loop unrolling
                    end select
            end do
        ...
        deallocate(times,sums,a,b,c,indices)
        ! stop
    end do
