program main_clouds
    ...
    type(clouds_regressor)    :: et_reg_slow, et_reg_fast, et_reg_fast_more
...
!     n_iters = 1
    ...
    do iii=1, 5, 1
        ...
        do jjj=1, 5, 1
            ...
            et_reg_fast = clouds_regressor(max_leaf_nodes=max_leaf_nodes, fashion="best", & 
